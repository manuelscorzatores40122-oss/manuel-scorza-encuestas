...
export function GestorAnunciosPsi({ announcements }: { announcements: Post[] }) {
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.colFeed}>
          ...
          {announcements.length === 0 ? (
            ...
            announcements.map(p => (
              <article key={p.id} className={`${styles.post} ${!p.isPublished ? styles.postHidden : ''}`}>
                <div className={styles.postTop}>
                  <div className={styles.postTitle}>
                    <h4 className={styles.postH4}>{p.title}</h4>
