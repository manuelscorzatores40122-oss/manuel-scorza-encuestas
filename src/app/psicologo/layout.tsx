...
import { LayoutDashboard, ClipboardList, AlertTriangle, Users, FileBarChart, Plus, Megaphone, BarChart3 } from 'lucide-react';
...
export default async function PsicologoLayout({ children }: { children: React.ReactNode }) {
  ...
  const nav = [
    ...
    { href: '/psicologo/estadisticas', label: 'Analítica', icon: <BarChart3 className="w-4 h-4" /> },
